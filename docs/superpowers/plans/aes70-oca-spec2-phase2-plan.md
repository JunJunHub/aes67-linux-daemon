...
- [ ] **Step 2: subscription_manager.cpp 实现 6 方法**
...
- [ ] **Step 3: subscription_manager.hpp 加 6 声明**
...
- [ ] **Step 6: commit** `feat(oca): G6/G7/EV1 实现 SubscriptionManager EV1+EV2 订阅方法(mi=1/2/5/6/10/11)`
...
- [ ] **Step 1: root.cpp handle_root 加 case**
...
- [ ] **Step 4: commit** `feat(oca): OcaRoot 实现 Lock/Unlock(mi=3/4,no-op)`
...
- [ ] **Step 2: device_manager.cpp 实现 4 方法 + 修 ClassID 常量**
...
- [ ] **Step 3: device_manager.hpp 加 4 声明**
...
- [ ] **Step 6: commit** `feat(oca): DeviceManager 实现 GetModelGUID/GetEnabled/SetEnabled/GetDeviceRevisionID`
...
- [ ] **Step 2: network_manager.cpp 实现 3 方法 + 修 ClassID 常量**
...
- [ ] **Step 3: network_manager.hpp 加 3 声明**
...
- [ ] **Step 6: commit** `feat(oca): NetworkManager 实现 GetStreamNetworks/GetControlNetworks/GetMediaTransportNetworks(返空列表)`
...
- [ ] **Step 2: device_manager.cpp 实现 2 方法**
...
- [ ] **Step 3: device_manager.hpp 加 2 声明**
...
- [ ] **Step 6: commit** `feat(oca): G3/G4 DeviceManager 实现 GetProduct(3.22)/GetManufacturer(3.21)`
